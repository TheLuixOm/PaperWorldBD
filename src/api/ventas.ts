...
export async function procesarVenta(input: { usuarioId?: string; items: Array<{ id: string; cantidad: number }> }) {
  return apiFetch<VentaProcesarResponse>('/api/ventas', {
    method: 'POST',
    body: JSON.stringify({
